...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_HEXOSKELETON = 322,
    ABILITY_LONE_WOLF = 323,
    ABILITY_EXSANGUINATE = 324,
    ABILITY_FIGHT_OR_FLIGHT = 325,
    ABILITY_PLAGUEBORNE = 326,
    ABILITY_RABID_FRENZY = 327,
    ABILITY_CHAIN_LIGHTNING = 328,
    ABILITY_IMMOLATION = 329,
    ABILITY_FREEZING_MAW = 330,
    ABILITY_ALTER_EGO = 331,
    ABILITY_SKELETATE = 332,
    ABILITY_ANTITHESIS = 333,
