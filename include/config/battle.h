...
#define B_ATE_MULTIPLIER            GEN_LATEST // In Gen7+, -ate abilities (Aerilate, Galvanize, Normalize, Pixilate, Refrigerate, Skeletate) multiply damage by 1.2. Otherwise, it's 1.3, except Normalize which has no multiplier.
