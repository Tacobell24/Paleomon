...
enum __attribute__((packed)) Ability
{
    ...
    // Custom abilities
    ABILITY_SPIKED_TAIL = 311,
    ABILITY_PYROMANIAC = 312,
    ABILITY_HEXOSKELETON = 313,
    ABILITY_LONE_WOLF = 314,
    ABILITY_HYDROPHOBIA = 315,
    ABILITY_SKELETATE = 316,
    ABILITY_PLAGUEBORNE = 317,
    ABILITY_EXSANGUINATE = 318,
    ABILITY_FIGHT_OR_FLIGHT = 319,
    ABILITY_PACK_HUNTING = 320,
