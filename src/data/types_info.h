...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar   Bone
    ...
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, X(2.0), ______, X(2.0)},
    [TYPE_ELECTRIC] = {______, ______, ______, X(2.0), ______, X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______, ______, X(0.5)},
    [TYPE_PSYCHIC]  = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, ______, X(0.0)},
    ...
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______, X(0.0)},
    ...
    [TYPE_BONE]     = {______, ______, X(2.0), ______, ______, ______, X(0.5), ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, ______, X(0.5), ______, X(2.0), ______, ______, ______},
};
...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    [TYPE_STELLAR] =
    {
        ...
        .teraTypeRGBValue = RGB(10, 18, 27),
        .damageCategory = DAMAGE_CATEGORY_SPECIAL,
        .paletteTMHM = gItemIconPalette_BoneTMHM, // failsafe
        .useSecondTypeIconPalette = FALSE,
        .isSpecialCaseType = TRUE,
        .isHiddenPowerType = FALSE,
    ...
    {
        .name = _("Bone"),
        .generic = _("a BONE move"),
        .palette = 13,
        .zMove = MOVE_SKELETAL_SMASH,
        .damageCategory = DAMAGE_CATEGORY_PHYSICAL,
        .paletteTMHM = gItemIconPalette_BoneTMHM,
        .useSecondTypeIconPalette = FALSE,
        .isSpecialCaseType = FALSE,
        .isHiddenPowerType = FALSE,
        //.enhanceItem = ITEM_FANG_NECKLACE,
        //.berry = ITEM_MANDI_BERRY,
        //.gem = ITEM_BONE_GEM,
        //.zCrystal = ITEM_BONINIUM_Z,
        //.plate = ITEM_BONY_PLATE,
        //.arceusForm = SPECIES_ARCEUS_BONE,
    },
};
