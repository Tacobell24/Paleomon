...
enum StringID
{
    ...
    STRINGID_HEXOSKELETONCURSE,
    STRINGID_PLAGUEBORNEINFESTED,
    STRINGID_RABIDFRENZYACTIVE,
    STRINGID_RABIDFRENZYDETERIORATED,
    STRINGID_PKMNCANTUSEMOVEFRENZY,
	STRINGID_LIGHTNINGSTRUCKPARTNER,
	STRINGID_CHAINLIGHTNINGFIZZLED,
	STRINGID_FOGENGULFED,
    STRINGID_HOSTARLESIEZEDCONTROL,
    STRINGID_PLUVENILEREGAINEDCONTROL,
    STRINGID_PKMNATESOMEEGG,
    STRINGID_OSTEOPOROSISWEAKENED,
    STRINGID_COUNT
};
...
// gAlterEgoStringIds
enum AlterEgoStringID
{
    B_MSG_ALTER_EGO_TAR,
    B_MSG_ALTER_EGO_FEATHER,
};
