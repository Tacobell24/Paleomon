...
static const struct FormChange sArceusFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_BONE,     ITEM_BONY_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_BONE,     ITEM_BONINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
