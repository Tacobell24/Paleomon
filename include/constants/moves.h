...
enum __attribute__((packed)) Move
{
    ...
    MOVE_TOOTH_AND_CLAW = 850,
    MOVE_ICY_FLAME_FIST = 851,
    MOVE_FLAME_BREATH = 852,
    MOVE_ICE_BREATH = 853,
    MOVE_BOLT_BREATH = 854,
    MOVE_BREATH_OF_DECAY = 855,
    MOVE_THAGOMIZE = 856,
    MOVE_FOSSILISE = 857,
    MOVE_OSTEOPOROSIS = 858,
    MOVE_FRIGID_GNAW = 859,
    MOVE_BLAZING_HORN = 860,
    MOVE_JAWS_OF_STEEL = 861,
    MOVE_BONE_FRAGMENTS = 862,
	MOVES_COUNT_CUSTOM,
